...
- **Global scope**: `C:/Users/micha/Desktop/Codebase/Personal/finance-tracker-ui/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/micha/Desktop/Codebase/Personal/finance-tracker-ui/.cursor/notes/`)
...
2. Glob `C:/Users/micha/Desktop/Codebase/Personal/finance-tracker-ui/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/micha/Desktop/Codebase/Personal/finance-tracker-ui/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/micha/Desktop/Codebase/Personal/finance-tracker-ui/.cursor/notes/` — works in any directory
